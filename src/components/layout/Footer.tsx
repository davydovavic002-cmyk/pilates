...
export function Footer({ compact = false }: FooterProps) {
  return (
    <footer
      className={`layout-footer relative border-t border-misty/30 overflow-hidden ${
        compact
          ? 'layout-footer--embed bg-transparent'
          : 'bg-cream/80 backdrop-blur-sm'
      }`}
    >
      {!compact && <SectionFlorals variant="footer" />}

      <div
        className={`layout-footer-inner relative z-10 max-w-7xl mx-auto px-6 lg:px-8 ${
      ...
      >
        ...
        <div className="mt-10 lg:mt-12 pt-6 lg:pt-8 border-t border-misty/25 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
